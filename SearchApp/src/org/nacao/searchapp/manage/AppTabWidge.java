...
public class AppTabWidge extends TabActivity {
	...
	public static final String TAB_STATIS = "tab_statistics";
		...
		tabHost.addTab(tabHost
				...
				.setContent(
						new Intent(this, UserinfoActivity.class).addFlags(
								...
								"tag_switch", "2")));
		tabHost.addTab(tabHost
				.newTabSpec(TAB_STATIS)
				.setIndicator(TAB_STATIS)
				.setContent(
						new Intent(this, StatisticsActivity.class).putExtra(
								"tag_switch", "3")));
...
//		 mPager = (ViewPager) findViewById(R.id.vPager);
		...
		listViews.add(getView("4", intent));
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 1:
				...
				break;
			case 2:
				r_b1 = (RadioButton) findViewById(R.id.radio_button2);
				tabHost.setCurrentTab(2);
				break;
			case 3:
